...
import com.yjf.bi.model.dto.user.*;
...
public class UserController {
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest) {
        ...
        if (StringUtils.isAnyBlank(userAccount, userPassword, checkPassword, email, captcha)) {
            return null;
        }
        long result = userService.userRegister(userAccount, userPassword, checkPassword, email, captcha);
    ...
    public BaseResponse<Boolean> sendCaptcha(@RequestBody UserCaptchaRequest userCaptchaRequest){
        String email = userCaptchaRequest.getEmail();
        boolean result = userService.sendCaptcha(email);
        return ResultUtils.success(result);
    }
...
//        user.setUserPassword(encryptPassword);
    ...
    public BaseResponse<Page<UserVO>> listUserVOByPage(@RequestBody UserQueryRequest userQueryRequest,
        ...
        //整个过程实现了从数据库查询用户数据，进行分页处理，将user转换为userVO
